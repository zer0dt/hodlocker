    ...
    <>
      ...
      >
        <h5 id="drawer-label" className="pl-12 inline-flex items- center mb-2 text-lg font-semibold text-black dark:text-white">
          following {Object.keys(followingItems.locklikesToBitcoiners).length} bitcoiners
        </h5>
        ...
        <div className="mt-0 mb-24 pl-2">
          {Object.entries(followingItems.locklikesToBitcoiners) // Convert the object into an array of key-value pairs
