...
interface FollowerDrawerProps {
  ...
  followerDrawerOpen: boolean;
  followerDrawerToggle: () => void;
}

const FollowerDrawer = ({
  locklikedFromIndividualBitcoiners,
  followerDrawerOpen,
  followerDrawerToggle
}: FollowerDrawerProps) => {
  ...
  return (
    ...
    >
      <h5 id="drawer-label" className="pl-12 inline-flex items-center mb-2 text-lg font-semibold text-black dark:text-white">
        {Object.keys(locklikedFromIndividualBitcoiners).length} bitcoiners following
      </h5>
      ...
      <div className="mt-0 mb-24 pl-2">
        {Object.entries(locklikedFromIndividualBitcoiners) // Convert the object into an array of key-value pairs
