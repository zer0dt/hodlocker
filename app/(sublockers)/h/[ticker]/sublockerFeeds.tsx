...
const loading = () => {
  return (
    <div className="text-center py-32"> 
            <div role="status">
                <svg aria-hidden="true" className="my-2 inline w-8 h-8 mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-orange-400" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
